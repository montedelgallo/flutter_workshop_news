...
class BusinessTab extends StatefulWidget {
  @override
  _BusinessTabState createState() => new _BusinessTabState();
}
...
class _BusinessTabState extends State<BusinessTab> {
  ...
  void _fetchArticles() async {
    var url = 'https://newsapi.org/v2/top-headlines?country=it&category=business&apiKey=fc0b950863f0456ebe2c7721f024684c';
